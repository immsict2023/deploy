...
function ShowPersonnel() {
    const [ personnel_details_data, setPersonnel_Details_Data ] = useState({personnel_id: null, prefix: null, suffix: null, first_name: null, middle_name: null, last_name: null, date_of_birth: null, place_of_birth: null, gender: null, citizenship: null, marital_status: null, address: null, phone_no: null, designation: null, department: null, email: null, faculty_rank: null, primary_teaching_discipline: null, employment_type: null, employment_tenure: null, teaching_load: null, employed_since: null, employed_until: null, annual_salary: null, active: true, remarks: null, mobile_no: null})
                            ...
                            <form className='card shadow p-3 m-3 border-0' noValidate={false}>
                                <div className='container-fluid row'>
                                    ...
                                    <div className='col-4 mt-2'>
                                        <h6>Personnel ID</h6>
                                        <input type='text' className='form-control' name='personnel_id' id='personnel_id' value={personnel_details_data.personnelid && personnel_details_data.personnelid} disabled={!editMode}  />
                                    </div>
                                    <div className='col-4 mt-2'>
                                        <h6>Prefix</h6>
                                    ...
                                    <div className='col-4 mt-2'>
                                        <h6>Date of Birth</h6>
                                        <input type='date' className='form-control' name='dob' id='dob' onChange={inputData} disabled={!editMode} value={personnel_details_data.dob && defaultDateInputValue(personnel_details_data.dob)}/>
                                    </div>
                                    <div className='col-4 mt-2'>
                                    ...
                                    <div className='col-4 mt-2'>
                                        ...
                                        <input className='form-control' type='date' name='employedsince' id='employedsince'  onChange={inputData} disabled={!editMode} value={personnel_details_data.employedsince && defaultDateInputValue(personnel_details_data.employedsince)}/>
                                    </div>
                                    <div className='col-4 mt-2'>
                                        <h6>Employed Until</h6>
                                        <input className='form-control' type='date' name='employeduntil' id='employeduntil'  onChange={inputData} disabled={!editMode} value={personnel_details_data.employeduntil && defaultDateInputValue(personnel_details_data.employeduntil)}/>
                                    </div>
                                    <div className='col-4 mt-2'>
                                        <h6>Annual Salary</h6>
                ...
                <ModalFooter className='text-white' style={{backgroundColor: '#031B5B'}}>
                    <div className='container-fluid text-center'>
                        ...
                        <Link style={{ width: '100px' }} to='../' className='btn btn-danger me-2'>Close</Link>
                        {
                            !editMode ? 
                            <>
                                <button style={{ width: '100px' }} className='btn btn-primary me-2' onClick={handleEditMode}>Edit</button>
                            </>
                            :
                            <>
                                <button style={{ width: '100px' }} className='btn btn-secondary me-2' onClick={handleEditMode}>Cancel</button>
