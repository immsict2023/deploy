...
import UpdateStudentConfirmation from '../../Modal/ConfirmationModal/UpdateStudentConfirmation';
...
function EditStudent() {
  ...
  const updateDates = (res) => {
    const primary =  res.primaryschooltimeperiod.split('-');
    const second = res.highschooltimeperiod.split('-');
    const college = res.collegetimeperiod.split('-');
    setStudentInformation({
      ...studentInformation,
      primaryfromyear: primary[0],
      primarytoyear: primary[1],
      secondaryfromyear: second[0],
      secondarytoyear: second[1],
      collegefromyear: college[0],
      collegetoyear: college[1],
    })
  }
  ...
  return (
    <>
    { updateModalStatus && <UpdateStudentConfirmation modalStatus={updateModalStatus} setModalStatus={setUpdateModalStatus} data={studentInformation} /> }
      <Modal
        show={true}
        fullscreen
        backdrop='static'
      ...
      >
        <ModalHeader style={{backgroundColor: '#031B5B'}}>
            <div className='container-fluid text-white row'>
              <div className='col'>
                <h5 className='text-start'>EDIT STUDENT</h5>
              </div>
            </div>
        </ModalHeader>
        <ModalBody>
        ...
        <ModalFooter style={{backgroundColor: '#031B5B'}}>
          <div className='container-fluid text-center'>
            ...
            <button style={{width: '90px'}} className='btn btn-primary me-2' onClick={handleUpdateStudent}>Update</button>
