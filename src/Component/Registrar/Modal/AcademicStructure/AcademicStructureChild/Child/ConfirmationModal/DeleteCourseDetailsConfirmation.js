...
function DeleteCourseDetailsConfirmation(props) {

    const { modalStatus, setModalStatus , CourseDetailNo } = props
    
    const handleDeleteData = () => {
        
        crudDelete.deleteCourseDetail({ CourseDetailNo })
        .then((res) => {
...
export default DeleteCourseDetailsConfirmation
