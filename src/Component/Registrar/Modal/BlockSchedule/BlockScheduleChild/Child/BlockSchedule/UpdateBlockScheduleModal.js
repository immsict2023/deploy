...
import AddModalBlockConfirmation from '../../Modal/AddModalBlockConfirmation'
import AddBlockScheduleModal from '../../Modal/AddBlockScheduleModal'
...
function UpdateBlockScheduleModal() {

    const [blockScheduleData, setBlockScheduleData] = useState({ Program: "", Semester: "", AY: "", BlockType: "", Year: "", ProCourse: "", Curriculum: "", Section: "", Block: ""})
    ...
    const getBlockIndividualFunc = () => {
        view.getBlockIndividual({BlockID}).then((res) => {
            console.log(res.data.rows[0])
            setBlockScheduleData(res.data.rows[0])
            getCurriculumListFunc(res.data.rows[0].ProgramNo)
        }).catch((err) => {
            console.error(err)
        })
    }
    ...
    useEffect(() => {
        generateYear()
        getProgramListFunc()
        getBlockIndividualFunc({BlockID})
    }, [])
    ...
    return (
        ...
        { addBlockStatusModal && <AddModalBlockConfirmation modalStatus={addBlockStatusModal} setModalStatus={setAddBlockStatusModal} data={blockScheduleData} /> }
        { addBlockScheduleModalStatus && <AddBlockScheduleModal modalStatus={addBlockScheduleModalStatus} setModalStatus={setAddBlockScheduleModalStatus} data={{ Curriculum: blockScheduleData.CurriculumNo, Year: blockScheduleData.Year, Semester: blockScheduleData.Sem, BlockType: blockScheduleData.BlockType, BlockID: blockScheduleData.BlockID}} /> }
            <Modal
                show={true}
                fullscreen
                centered
                    ...
                    <div className='container-fluid' style={{ width: "1500px" }}>
                        <div className='row'>
                                ...
                                <div className='card shadow m-3 p-3'>
                                    <div className='row'>
                                        <div className='col-2 mt-2'>
                                            <h6>Block</h6>
                                            <input className='form-control border-0' name='Block' id='Block' defaultValue={blockScheduleData.BlockID && blockScheduleData.BlockID} disabled />
                                        </div>
                                        <div className='col-2 mt-2'>
                                            <h6>Program</h6>
                                            <select onChange={inputData} className='form-control' name='Program' value={blockScheduleData.ProgramNo && blockScheduleData.ProgramNo} id='Program' disabled={true}>
                                                <option></option>
                                                {
                                        ...
                                        <div className='col-2 mt-2'>
                                            <h6>Semester</h6>
                                            <select onChange={inputData} className='form-control' name='Semester' value={blockScheduleData.Sem && blockScheduleData.Sem} id='Semester' disabled={true}>
                                                <option></option>
                                        ...
                                        <div className='col-2 mt-2'>
                                            <h6>Year</h6>
                                            <select onChange={inputData} className='form-control' value={blockScheduleData.Year && blockScheduleData.Year} name='Year' id='Year' disabled={true}>
                                                <option></option>
                                        ...
                                        <div className='col-2 mt-2'>
                                            <h6>AY</h6>
                                            <select onChange={inputData} className='form-control' value={blockScheduleData.AY && blockScheduleData.AY} name='AY' id='AY' disabled={true}>
                                                <option></option>
                                                {
                                        ...
                                        <div className='col-2 mt-2'>
                                            <h6>Block Type</h6>
                                            <select onChange={inputData} className='form-control' value={blockScheduleData.BlockType && blockScheduleData.BlockType} name='BlockType' id='BlockType' disabled={true}>
                                                <option></option>
                                        ...
                                        <div className='col-2 mt-2'>
                                            <h6>Section</h6>
                                            <input className='form-control border-0' name='Section' id='Section' value={blockScheduleData.Section && blockScheduleData.Section} disabled/>
                                        </div>
                                        <div className='col-4 mt-2'>
                                            <h6>Curriculum</h6>
                                            <select onChange={inputData} className='form-control' value={blockScheduleData.CurriculumNo && blockScheduleData.CurriculumNo} name='Curriculum' id='Curriculum' disabled={true}>
                                                <option></option>
                                                {
                                        ...
                                        </div>
                                        {
                                            /*
                                                <div className='col-12 text-center m-4'>
                                                    <button onClick={handleSubmit} className='btn btn-primary' disabled={true}>CREATE BLOCK</button>
                                                </div>
                                            */
                                        }
                                    </div>
                            ...
                            <div className='col-12'>
                                <div className='card shadow m-3 p-3'>
                                    <div className='container-fluid'>
                                        <button className='btn btn-primary mt-3 mb-3' onClick={() => setAddBlockScheduleModalStatus(true)} disabled={!true}>ADD SCHEDULE</button>
                                    </div>
...
export default UpdateBlockScheduleModal
